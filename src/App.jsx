...
function App() {
  ...
  const playerIcon = useRef(null);
  const cpuIcon = useRef(null);
  const playerFist = useRef(null);
  const cpuFist = useRef(null);
